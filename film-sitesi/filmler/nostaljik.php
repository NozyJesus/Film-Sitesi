    ...
    <div class="page">
      <header class="section page-header page-header-1 context-dark">
        <div class="page-header-1-figure m-parallax">
          <div class="page-header-1-image m-parallax-image" style="background-image: url(../images/film-kategori-bg/nostaljik.png);"></div>
        </div>
        <!-- Navbar Başlangıç -->
          ...
          <div class="breadcrumbs-custom-inner">
            <div class="container">
              <div class="breadcrumbs-custom-main m-parallax-content">
                <h2 class="breadcrumbs-custom-title">Nostaljik</h2>
                <p>
                Nostaljik filmler, genellikle geçmişe özlem duygusuyla bağlantılı eski zamanları ve kültürel mirası yansıtan yapıtlardır. 
                Bu tür filmler, izleyiciyi geçmişe götürerek o dönemin atmosferini ve yaşantısını yeniden keşfetmelerini sağlar. 
                Türk sinemasında nostaljik filmler, genellikle belirli bir dönemin sosyal, 
                kültürel veya politik önemli olaylarına odaklanır ve o dönemin ruhunu yansıtan karakterler ve hikayeler içerir. 
                Yerli izleyicinin geçmişe duyduğu özlemi ve nostaljiyi canlandıran bu filmler, kültürel mirasımızın korunmasına da katkıda bulunur.
                </p>
              </div>
            </div>
          </div>
