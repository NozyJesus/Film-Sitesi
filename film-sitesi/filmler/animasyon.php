    ...
    <div class="page">
      <header class="section page-header page-header-1 context-dark">
        <div class="page-header-1-figure m-parallax">
          <div class="page-header-1-image m-parallax-image" style="background-image: url(../images/film-kategori-bg/animasyon.png);"></div>
        </div>
        <!-- Navbar Başlangıç -->
          ...
          <div class="breadcrumbs-custom-inner">
            <div class="container">
              <div class="breadcrumbs-custom-main m-parallax-content">
                <h2 class="breadcrumbs-custom-title">Animasyon</h2>
                <p>
                Animasyon filmleri, çizgi film veya bilgisayar grafikleriyle oluşturulan karakterler ve dünyalar aracılığıyla anlatılan öykülerdir. 
                Bu tür, hayal gücünün sınırlarını zorlayan ve görsel olarak zengin dünyaları izleyiciyle buluşturan bir sanat formudur. 
                Türk animasyon sineması da renkli karakterleri, eğlenceli hikayeleri ve bazen derin temaları işleyerek geniş bir izleyici kitlesine hitap eder. 
                Animasyon filmleri, izleyicilere fantastik bir kaçış sunarken aynı zamanda önemli mesajları da işleyebilir.
                </p>
              </div>
            </div>
          </div>
