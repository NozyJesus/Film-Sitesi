    ...
    <div class="page">
      <header class="section page-header page-header-1 context-dark">
        <div class="page-header-1-figure m-parallax">
          <div class="page-header-1-image m-parallax-image" style="background-image: url(../images/film-kategori-bg/aksiyon.png);"></div>
        </div>
        <!-- Navbar Başlangıç -->
          ...
          <div class="breadcrumbs-custom-inner">
            <div class="container">
              <div class="breadcrumbs-custom-main m-parallax-content">
                <h2 class="breadcrumbs-custom-title">Aksiyon</h2>
                <p>Aksiyon filmleri, hareketli sahneleri, heyecan verici mücadeleleri ve genellikle fiziksel eylemleri ön planda tutan bir film türüdür. 
                  Aksiyon filmleri genellikle kahramanların maceralarını, cesurca mücadelelerini ve tehlikeli görevlerini konu alır. 
                  Olayların hızlı ilerlediği, adrenalini yüksek sahnelerin sıkça yer aldığı bu tür, izleyiciye gerilim dolu bir deneyim sunar. 
                  Türk sinemasında da önemli bir yere sahip olan aksiyon filmleri, izleyicilere aksiyon dolu bir film deneyimi yaşatmayı hedefler.
                </p>
              </div>
            </div>
          </div>
