    ...
    <div class="page">
      <header class="section page-header page-header-1 context-dark">
        <div class="page-header-1-figure m-parallax">
          <div class="page-header-1-image m-parallax-image" style="background-image: url(../images/film-kategori-bg/klasik.png);"></div>
        </div>
        <!-- Navbar Başlangıç -->
          ...
          <div class="breadcrumbs-custom-inner">
            <div class="container">
              <div class="breadcrumbs-custom-main m-parallax-content">
                <h2 class="breadcrumbs-custom-title">Klasik</h2>
                <p>
                Klasik Türk filmleri, genellikle belirli bir dönemin kültürel ve sosyal değerlerini yansıtan, 
                zamanının öne çıkan sanatçıları ve yönetmenleri tarafından çekilen önemli eserlerdir. 
                Bu filmler, Türk sinemasının gelişimine ve evrimine tanıklık eden, izleyicilere nostaljik bir yolculuk sunan yapıtlardır. 
                Genellikle güçlü karakter gelişimleri, derinlikli hikayeler ve zamanın ruhunu yansıtan atmosferleriyle öne çıkarlar. 
                Klasik Türk filmleri, hem sanatsal değerleri hem de kültürel mirası korumak adına önemli bir yer tutar.
                </p>
              </div>
            </div>
          </div>
