    ...
    <div class="page">
      <header class="section page-header page-header-1 context-dark">
        <div class="page-header-1-figure m-parallax">
          <div class="page-header-1-image m-parallax-image" style="background-image: url(../images/film-kategori-bg/gerilim.png);"></div>
        </div>
        <!-- Navbar Başlangıç -->
          ...
          <div class="breadcrumbs-custom-inner">
            <div class="container">
              <div class="breadcrumbs-custom-main m-parallax-content">
                <h2 class="breadcrumbs-custom-title">Gerilim</h2>
                <p>
                Gerilim filmleri, izleyiciyi gizemli olaylar, beklenmedik dönemeçler ve yüksek tansiyonlu anlarla dolu bir yolculuğa çıkaran film türüdür. 
                Bu tür, genellikle karakterler arasındaki psikolojik çekişmelere, sürprizlere ve entrikalara dayalıdır. 
                Türk gerilim sineması da bu tarzı sürdürerek izleyicilere yerli yapımlarda da bu türün heyecanını ve derinliğini sunar. 
                Zaman zaman polisiye unsurlarla da harmanlanan Türk gerilim filmleri, seyirciyi merak içinde bırakarak film boyunca gerilimi sürekli olarak tırmandırır. 
                Bu tür filmler, sürükleyici hikayeleri ve çarpıcı karakter analizleriyle dikkat çeker, izleyiciyi adeta ekran başına kilitlemeyi başarır.
                </p>
              </div>
            </div>
          </div>
