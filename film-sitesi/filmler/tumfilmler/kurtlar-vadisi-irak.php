...
<html class="wide wow-animation">
  <head>
    <title>Kurtlar Vadisi Irak</title>
    <meta charset="utf-8">
          ...
          <div class="row row-30 flex-column-reverse flex-lg-row">
            <div class="col-lg-8">
              <article class="post-info inset-1">
                <h4 class="post-info-title">Kurtlar Vadisi Irak</h4>
                <div class="post-info-meta bg-gray-100">
                  <ul class="post-info-meta-list">
                    <li><span class="icon mdi mdi-calendar-blank"></span><span class="small-text font-weight-sbold">2006-02-03</span></li>
                    <li><span class="icon mdi mdi-star-outline"></span><span class="small-text font-weight-sbold">IMDB: 5.7/10</span></li>
                  </ul>
                </div>
                <p>Film, Amerikalı askerlerin Türk özel kuvvetlerine düzenlediği bir baskınla başlar. Bu olay, Türk kamuoyunda büyük bir yankı uyandırır ve intikam isteğiyle yanıp tutuşan Polat Alemdar (Necati Şaşmaz) ve ekibini harekete geçirir. Polat Alemdar, vatanseverliği ve kararlılığıyla tanınan bir gizli operatördür. Ekibiyle birlikte Irak’a doğru yola çıkarak, baskından sorumlu Amerikalı komutan Sam William Marshall'ı (Billy Zane) bulup adaleti sağlamak için tehlikeli bir göreve atılır.

Irak’ın kaotik ortamında ilerleyen Polat ve ekibi, yerel direnişçilerle iş birliği yaparak adaleti sağlama çabası içine girerler. Film, savaşın ve işgalin insanlık üzerindeki yıkıcı etkilerini çarpıcı bir şekilde gözler önüne sererken, aksiyon dolu sahneleri ve derinlikli karakter analizleriyle dikkat çeker. Polat Alemdar'ın kararlılığı ve liderliği, izleyicilere unutulmaz bir kahramanlık hikayesi sunar.</p>
                <table class="post-info-table">
                  ...
                  <tr>
                    ...
                    <td>Necati Şaşmaz, Gürkan Uygun, Kenan Çoban, Erhan Ufak, Bergüzar Korel, Billy Zane, Gary Busey, Diego Serrano, Ghassan Massoud</td>
                  </tr>
                  <tr>
                    <td>Film Süresi</td>
                    <td>124 dakika</td>
                  ...
                  <tr>
                    <td>Fragman Linki</td>
                    <td>https://youtu.be/rmsHO9puwD0?si=FPVWh2dxPtlucyJL</td>
                  </tr>
                  <tr>
                    <td>İzleme Linki</td>
                    <td>https://youtu.be/JulvdANGUbI?si=FQinprvejyuAkN3G</td>
                  </tr>
                </table>
              </article>
            </div>
            <div class="col-lg-4 text-center text-lg-start">
              <div class="movie-page-image"><img src="../../uploads/../uploads/Kurtlar Vadisi Irak.png" alt="" width="375" height="491">
              </div>
            </div>
          </div>
        </div>
