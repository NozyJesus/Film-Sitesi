...
<html class="wide wow-animation">
  <head>
    <title>Rafadan Tayfa Dehliz Macerası</title>
    <meta charset="utf-8">
          ...
          <div class="row row-30 flex-column-reverse flex-lg-row">
            <div class="col-lg-8">
              <article class="post-info inset-1">
                <h4 class="post-info-title">Rafadan Tayfa Dehliz Macerası</h4>
                <div class="post-info-meta bg-gray-100">
                  <ul class="post-info-meta-list">
                    <li><span class="icon mdi mdi-calendar-blank"></span><span class="small-text font-weight-sbold">2018-10-26</span></li>
                    <li><span class="icon mdi mdi-star-outline"></span><span class="small-text font-weight-sbold">IMDB: 6.3/10</span></li>
                  </ul>
                </div>
...
Ancak hazine peşindeki tek grup onlar değildir. Rakip ekip ve kötü niyetli karakterler de hazineyi ele geçirmek için peşlerine düşer. Rafadan Tayfa, dostluklarını ve birliklerini test eden bu zorlu mücadelede birbirlerine destek olurken, eski mahallelerinde unutulmaz bir serüven yaşarlar.</p>
                <table class="post-info-table">
                  ...
                  <tr>
                    ...
                    <td>Enes Batur (Akın), Şerif Sezer (Kamil), Şirin Giobbi (İlayda), Levent Kol (Bücür), Zafer Algöz (Müdür Mümin), Ayşen Gruda (Nene)</td>
                  </tr>
                  <tr>
                    <td>Film Süresi</td>
                    <td>84 dakika</td>
                  ...
                  <tr>
                    <td>Fragman Linki</td>
                    <td>https://youtu.be/eF-dwJ5cKsM?si=D3leEKaIvQGM1sPX</td>
                  </tr>
                  <tr>
                    <td>İzleme Linki</td>
                    <td>https://www.fullhdfilmizlesene.de/film/rafadan-tayfa-dehliz-macerasi/</td>
                  </tr>
                </table>
              </article>
            </div>
            <div class="col-lg-4 text-center text-lg-start">
              <div class="movie-page-image"><img src="../../uploads/../uploads/Rafadan Tayfa.png" alt="" width="375" height="491">
              </div>
            </div>
          </div>
        </div>
