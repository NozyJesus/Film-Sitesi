          ...
          <div class="row row-30 flex-column-reverse flex-lg-row">
            <div class="col-lg-8">
              <article class="post-info inset-1">
                <h4 class="post-info-title">Issız Adam</h4>
                <div class="post-info-meta bg-gray-100">
                  <ul class="post-info-meta-list">
                    <li><span class="icon mdi mdi-calendar-blank"></span><span class="small-text font-weight-sbold">2008-11-07</span></li>
                    <li><span class="icon mdi mdi-star-outline"></span><span class="small-text font-weight-sbold">IMDB: 6.8/10</span></li>
                  </ul>
                </div>
                <p>Film, yalnızlık içinde yaşayan Alper'in hikayesiyle başlar. Alper, eski bir matematik öğretmenidir ve İstanbul'un trafiği ve kalabalığı arasında hayatını sürdürmektedir. Bir gün, tesadüfen tanıştığı Ada ile aralarında beklenmedik bir yakınlık başlar. Ada'nın enerjisi ve hayat doluluğu, Alper'in monoton yaşantısına yeni bir perspektif kazandırır.

Alper ve Ada arasında başlayan bu ilişki, ikisinin de hayatında derin izler bırakır. Ancak geçmişin gölgeleri ve Alper'in içsel çatışmaları, mutluluğun önünde engel oluşturur. İkisi de kendi iç dünyalarında yolculuk ederken, aşkın ve anlayışın gücünü keşfederler.</p>
                <table class="post-info-table">
                  ...
                  <tr>
                    ...
                    <td>Cemal Hünal, Melis Birkan, Yıldız Kültür, Şerif Bozkurt, Gözde Kansu, Aslı Aybars, Goncagül Sunar</td>
                  </tr>
                  <tr>
                    <td>Film Süresi</td>
                    <td>93 dakika</td>
                  ...
                  <tr>
                    <td>Fragman Linki</td>
                    <td>https://youtu.be/eFkKOG0uzpo?si=nMNtjadiYPBTlVDB</td>
                  </tr>
                  <tr>
                    <td>İzleme Linki</td>
                    <td>https://www.youtube.com/watch?v=_9OBWPc9h1o&list=PLMAaxzeWQJlVPmpe-VcAoAnQmELPnYwMP&index=2</td>
                  </tr>
                </table>
              </article>
            </div>
            <div class="col-lg-4 text-center text-lg-start">
              <div class="movie-page-image"><img src="../../uploads/../uploads/Issız adam.png" alt="" width="375" height="491">
              </div>
            </div>
          </div>
        </div>
