...
<html class="wide wow-animation">
  <head>
    <title>Kötü Kedi Şerafettin</title>
    <meta charset="utf-8">
          ...
          <div class="row row-30 flex-column-reverse flex-lg-row">
            <div class="col-lg-8">
              <article class="post-info inset-1">
                <h4 class="post-info-title">Kötü Kedi Şerafettin</h4>
                <div class="post-info-meta bg-gray-100">
                  <ul class="post-info-meta-list">
                    <li><span class="icon mdi mdi-calendar-blank"></span><span class="small-text font-weight-sbold">2016-02-05</span></li>
                    <li><span class="icon mdi mdi-star-outline"></span><span class="small-text font-weight-sbold">IMDB: 7/10</span></li>
                  </ul>
                </div>
                <p>Film, İstanbul'un sokaklarında yaşayan serseri kedi Şerafettin'in maceralarını konu alır. Sert mizacı ve asi ruhuyla tanınan Şerafettin, babası Tonguç, yakın dostları Fare Rıza ve Martı Rıfkı ile birlikte yaşamaktadır. Şerafettin, rutin hayatına devam ederken, bir gün eski düşmanlarıyla karşılaşır ve olaylar çığırından çıkar.
...
Film boyunca Şerafettin, çeşitli belalarla ve düşmanlarla mücadele ederken, bir yandan da komik ve beklenmedik olaylarla başa çıkmak zorunda kalır. Şerafettin'in hayatta kalma mücadelesi, komik diyaloglar ve absürd durumlarla dolu, hızlı tempolu bir maceraya dönüşür.
                ...
                <table class="post-info-table">
                  <tr>
                    <td>Yönetmenler</td>
                    <td>Mehmet Kurtuluş, Ayşe Ünal</td>
                  </tr>
                  <tr>
                    <td>Başrol Oyuncuları</td>
                    <td>Uğur Yücel (Şerafettin), Demet Evgar (Misket), Okan Yalabık (Rıza), Güven Kıraç (Tonguç), Gökçe Özyol (Rıfkı), Ahmet Mümtaz Taylan (Kötü Kenan)</td>
                  </tr>
                  <tr>
                    <td>Film Süresi</td>
                    <td>86 dakika</td>
                  ...
                  <tr>
                    <td>Fragman Linki</td>
                    <td>https://youtu.be/un5n6tpRT-8?si=oEb1HFclIJboTJUe</td>
                  </tr>
                  <tr>
                    <td>İzleme Linki</td>
                    <td>https://youtu.be/VDzII45fC9Y?si=AKywgFXUIRj_JpTc</td>
                  </tr>
                </table>
              </article>
            </div>
            <div class="col-lg-4 text-center text-lg-start">
              <div class="movie-page-image"><img src="../../uploads/../uploads/Kötü Kedi Şerafettin.png" alt="" width="375" height="491">
              </div>
            </div>
          </div>
        </div>
