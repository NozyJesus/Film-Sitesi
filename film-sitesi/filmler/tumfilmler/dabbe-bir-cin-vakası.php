...
<html class="wide wow-animation">
  <head>
    <title>Dabbe Bir Cin Vakası</title>
    <meta charset="utf-8">
          ...
          <div class="row row-30 flex-column-reverse flex-lg-row">
            <div class="col-lg-8">
              <article class="post-info inset-1">
                <h4 class="post-info-title">Dabbe Bir Cin Vakası</h4>
                <div class="post-info-meta bg-gray-100">
                  <ul class="post-info-meta-list">
                    <li><span class="icon mdi mdi-calendar-blank"></span><span class="small-text font-weight-sbold">2012-08-03</span></li>
                    <li><span class="icon mdi mdi-star-outline"></span><span class="small-text font-weight-sbold">IMDB: 5.8/10</span></li>
                  </ul>
                </div>
                <p>Gerçek olaylardan esinlenerek hazırlanmış bir korku filmi. Film, Türkiye'nin İzmir şehrinde yaşayan Ceyda ve ailesinin başına gelen ürkütücü olayları konu alıyor. Ceyda, evinde ve çevresinde açıklanamayan, korkutucu olaylar yaşamaya başlar. Bu olaylar arttıkça, ailenin huzuru bozulur ve Ceyda, yaşadığı dehşeti çözmek için bir parapsikolog ekibinden yardım almaya karar verir.
...
Parapsikolog ekibi, evdeki paranormal aktiviteleri incelemek üzere eve yerleşir ve yaşanan olayları kayıt altına almaya başlar. Ancak, araştırmalar ilerledikçe olayların ardındaki korkunç gerçekler ortaya çıkar. Ceyda ve ailesi, cinlerin hedefi haline gelmiştir ve hayatta kalmak için zorlu bir mücadele vermek zorundadırlar.
                ...
                <table class="post-info-table">
                  ...
                  <tr>
                    ...
                    <td>Nihan Aypolat, Koray Kadirağa, Pervin Bağdat</td>
                  </tr>
                  <tr>
                    <td>Film Süresi</td>
                    <td>119 dakika</td>
                  ...
                  <tr>
                    <td>Fragman Linki</td>
                    <td>https://youtu.be/oA3tVlB2jzk?si=63AhJYUavLUhuHD-</td>
                  </tr>
                  <tr>
                    <td>İzleme Linki</td>
                    <td>https://youtu.be/qdG-TeX3p74?si=xCbJjGK7rTV9UlV5</td>
                  </tr>
                </table>
              </article>
            </div>
            <div class="col-lg-4 text-center text-lg-start">
              <div class="movie-page-image"><img src="../../uploads/../uploads/Dabbe Bir Cin Vakası.png" alt="" width="375" height="491">
              </div>
            </div>
          </div>
        </div>
