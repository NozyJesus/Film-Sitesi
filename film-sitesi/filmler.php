      ...
      <div class="page">
        <header class="section page-header page-header-1 context-dark">
          <div class="page-header-1-figure m-parallax">
            <div class="page-header-1-image m-parallax-image" style="background-image: url(images/bg-image-3.jpg);"></div>
          </div>
          <!-- Navbar Başlangıç -->
                ...
                <div class="rd-navbar-main">
                  ...
                  <div class="rd-navbar-nav-wrap">
                    <ul class="rd-navbar-nav">
                      ...
                      <li class="rd-nav-item active"><a class="rd-nav-link" href="filmler.php">FİLMLER</a></li>
                    </ul>
                  </div>
            ...
            <div class="breadcrumbs-custom-inner">
              <div class="container">
                <div class="breadcrumbs-custom-main m-parallax-content">
                  <h2 class="breadcrumbs-custom-title">Filmler</h2>
                  <p style="font-size: 16px;"><b>İstediğin film kategorisini seç ve keşfe çık!</b></p>
                </div>
              </div>
            </div>
          </section>
        ...
        <section class="section section-lg bg-gray-100">
            <div class="container">
              <div class="row row-30">
                <div class="col-6 col-sm-4"><a class="destination-1 context-dark" href="filmler/drama.php">
                ...
                <div class="col-6 col-sm-4"><a class="destination-1 context-dark" href="filmler/animasyon.php">
                    <figure class="destination-1-figure">
                      <div class="destination-1-image bg-image" style="background-image: url(images/destinations-10-363x260.jpg);"></div>
                    </figure>
                    <div class="destination-1-caption">
                      <p class="heading-4 destination-1-title">Animasyon</p>
                    </div></a>
                </div>
                <div class="col-6 col-sm-4"><a class="destination-1 context-dark" href="filmler/korku.php">
                    <figure class="destination-1-figure">
                ...
                <div class="col-6 col-sm-4"><a class="destination-1 context-dark" href="filmler/nostaljik.php">
                    <figure class="destination-1-figure">
                      <div class="destination-1-image bg-image" style="background-image: url(images/destinations-4-363x260.jpg);"></div>
                    </figure>
                    <div class="destination-1-caption">
                      <p class="heading-4 destination-1-title">Nostaljik</p>
                    </div></a>
                </div>
                <div class="col-6 col-sm-4"><a class="destination-1 context-dark" href="filmler/komedi.php">
                    <figure class="destination-1-figure">
                ...
                <div class="col-6 col-sm-4"><a class="destination-1 context-dark" href="filmler/gerilim.php">
                    <figure class="destination-1-figure">
                      <div class="destination-1-image bg-image" style="background-image: url(images/destinations-8-363x260.jpeg);"></div>
                    </figure>
                    <div class="destination-1-caption">
                      <p class="heading-4 destination-1-title">Gerilim</p>
                    </div></a>
                </div>
                <div class="col-6 col-sm-4"><a class="destination-1 context-dark" href="filmler/aksiyon.php">
                  <figure class="destination-1-figure">
                    <div class="destination-1-image bg-image" style="background-image: url(images/destinations-9-363x260.jpg);"></div>
                  </figure>
                  <div class="destination-1-caption">
                    <p class="heading-4 destination-1-title">Aksiyon</p>
                  </div></a>
              </div>
              <div class="col-6 col-sm-4"><a class="destination-1 context-dark" href="filmler/klasik.php">
                <figure class="destination-1-figure">
                  <div class="destination-1-image bg-image" style="background-image: url(images/destinations-11-363x260.jpg);"></div>
                </figure>
                <div class="destination-1-caption">
                  <p class="heading-4 destination-1-title">Klasik</p>
                </div></a>
              </div>
              <div class="col-6 col-sm-4"><a class="destination-1 context-dark" href="filmler/romantik.php">
                <figure class="destination-1-figure">
