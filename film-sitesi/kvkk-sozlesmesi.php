  ...
  <body>
    ...
    <div class="page">
      <header class="section page-header page-header-1 context-dark">
          ...
          <div class="breadcrumbs-custom-inner">
            <div class="container">
              <div class="breadcrumbs-custom-main m-parallax-content">
                <h2 class="breadcrumbs-custom-title">KVKK Sözleşmesi</h2>
              </div>
            </div>
          </div>
        </section>
        ...
        <!-- KVKK Metni Başlangıç -->
        <section class="section section-lg bg-default">
        <div class="container">
          <dl class="list-terms">
            <dt class="heading-5">RetroFilm Kişisel Verilerin Korunması</dt>
            <dd>RetroFilm olarak, kullanıcılarımızın kişisel verilerinin güvenliği ve gizliliğine büyük önem veriyoruz. Bu sebeple, 6698 sayılı Kişisel Verilerin Korunması Kanunu (KVKK) kapsamında, kişisel verilerinizi nasıl topladığımız, kullandığımız, sakladığımız ve koruduğumuz hakkında sizi bilgilendirmek istiyoruz.</dd>
            <dt class="heading-5">Kişisel Verilerin Aktarılması</dt>
            <dd>Kişisel verileriniz, yasal yükümlülükler gereği yetkili kamu kurum ve kuruluşlarına, iş ortaklarımıza ve hizmet sağlayıcılarımıza aktarılabilir.</dd>
            <dt class="heading-5">Kişisel Verilerin Toplanma Yöntemi ve Hukuki Sebebi</dt>
            <dd>Kişisel verileriniz, RetroFilm internet sitesi üzerinden elektronik ortamda toplanmaktadır. Bu veriler, KVKK’nın 5. ve 6. maddelerinde belirtilen hukuki sebeplere dayanarak işlenmektedir.</dd>
            <dt class="heading-5">Kişisel Verilerin Saklanma Süresi</dt>
            <dd>Kişisel verileriniz, işlenme amaçlarının gerektirdiği süre boyunca ve yasal saklama süreleri çerçevesinde saklanır. Saklama süresi sona erdiğinde, kişisel verileriniz silinir, yok edilir veya anonim hale getirilir.</dd>
            <dt class="heading-5">İletişim</dt>
            <dd>KVKK kapsamında, haklarınıza ilişkin taleplerinizi ve kişisel verilerinizle ilgili her türlü sorularınızı [e-posta adresi] üzerinden bize iletebilirsiniz. Talepleriniz en kısa sürede değerlendirilerek, KVKK kapsamında gerekli işlemler yapılacaktır.<br><br>RetroFilm olarak, kişisel verilerinizin korunmasına yönelik gerekli tüm tedbirleri aldığımızı ve almaya devam edeceğimizi taahhüt ederiz.</dd>
          </dl><a class="privacy-link" href="mailto: sedefahishavi@gmail.com">sedefahishavi@gmail.com</a>
        </div>
        </section>
        <!-- KVKK Metni Bitiş -->
        <!-- Footer Başlangıç -->
