  ...
  <body>
    ...
    <div class="page">
      <header class="section page-header page-header-1 context-dark">
          ...
          <div class="breadcrumbs-custom-inner">
            <div class="container">
              <div class="breadcrumbs-custom-main m-parallax-content">
                <h2 class="breadcrumbs-custom-title">Gizlilik Politikası</h2>
              </div>
            </div>
          </div>
        </section>
        ...
        <div class="container">
          <dl class="list-terms">
            <dt class="heading-5">RetroFilm Gizlilik Politikası</dt>
            <dd>RetroFilm olarak, kullanıcılarımızın gizliliğine büyük önem veriyoruz. Bu Gizlilik Politikası, kişisel verilerinizin nasıl toplandığını, kullanıldığını ve korunduğunu açıklamaktadır.</dd>
            <dt class="heading-5">Çerezler</dt>
            <dd>Çerezler, web sitemizi ziyaret ettiğinizde tarayıcınıza gönderilen küçük veri dosyalarıdır. Çerezler, site içindeki tercihlerinizi hatırlamamıza ve kullanıcı deneyiminizi geliştirmemize yardımcı olur. Çerezleri tarayıcı ayarlarınızdan yönetebilir veya silebilirsiniz.</dd>
            <dt class="heading-5">Üçüncü Taraflarla Paylaşım</dt>
            <dd>Kişisel bilgilerinizi üçüncü taraflarla paylaşmayız, satmayız veya kiralamayız. Ancak, yasal zorunluluklar veya kullanıcı sözleşmemizin ihlali durumlarında yetkili mercilerle paylaşabiliriz.</dd>
            <dt class="heading-5">Verilerin Güvenliği</dt>
            <dd>Kişisel bilgilerinizin güvenliğini sağlamak için gerekli teknik ve idari önlemleri alıyoruz. Ancak, internet üzerinden veri iletiminin tamamen güvenli olduğunu garanti edemeyiz.</dd>
            <dt class="heading-5">Gizlilik Politikasında Değişiklikler</dt>
            <dd>Gizlilik Politikamızı zaman zaman güncelleyebiliriz. Güncellemeler web sitemizde yayınlanacaktır. Gizlilik Politikası'ndaki değişikliklerden haberdar olmak için bu sayfayı düzenli olarak kontrol etmenizi öneririz.</dd>
