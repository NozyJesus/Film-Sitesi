          ...
          <div class="row row-30 flex-column-reverse flex-lg-row">
            <div class="col-lg-8">
              <article class="post-info inset-1">
                <h4 class="post-info-title">Filim Adı</h4>
                <div class="post-info-meta bg-gray-100">
                  <ul class="post-info-meta-list">
                    <li><span class="icon mdi mdi-calendar-blank"></span><span class="small-text font-weight-sbold">Çıkış Tarihi burada yazacak</span></li>
                    <li><span class="icon mdi mdi-star-outline"></span><span class="small-text font-weight-sbold">IMDB: Puanı burada yazacak</span></li>
                  </ul>
                </div>
                <p>Film Açıklaması burada yazacak</p>
                <table class="post-info-table">
                  <tr>
                    <td>Başrol Oyuncuları</td>
                    <td>Başrol Oyuncuları buraya yazılacak</td>
                  </tr>
                  <tr>
                    <td>Film Süresi</td>
                    <td>Film Süresi Buraya yazacak</td>
                  </tr>
                  <tr>
                    <td>Film Kategorisi</td>
                    <td>Film Kategorisi buraya yazacak</td>
                  </tr>
                </table>
              </article>
            </div>
            <div class="col-lg-4 text-center text-lg-start">
              <!-- Buraya eklenilen görsel gelecek yani kapak fotoğrafı -->
              <div class="movie-page-imageg"><img src="images/movie-page-image-375x491.jpg" alt="" width="375" height="491">
              </div>
            </div>
          </div>
        </div>
